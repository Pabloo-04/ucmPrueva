...
public class Growlithe extends Pokemon implements AttackScratch, AttackFire {
    ...
    public void attackFire(String name, int damage, Pokemon enemy) {
        ...
        switch (enemy.getPokemontype()){
            ...
            case NORMAL,FIRE -> enemy.setHp(enemy.getHp() - (damage-3)*(1 + (getXp() -25 )/100));
            case GRASS -> enemy.setHp(enemy.getHp() - (damage-3)*(1 + (getXp() -25 )/100)*2);
